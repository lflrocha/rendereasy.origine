...
def setup_product():
    ...
    import rendereasy.origine
    zcml.load_config('configure.zcml', rendereasy.origine)
    ...
    ztc.installPackage('rendereasy.origine')
...
setup_product()
ptc.setupPloneSite(products=['rendereasy.origine'])
